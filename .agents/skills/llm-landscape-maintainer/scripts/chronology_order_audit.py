...
TITLE_OVERRIDES: tuple[tuple[str, tuple[int, int]], ...] = (
    (r"\bBACON\.5: The Discovery of Conservation Laws\b", (198108, 0)),
    (r"\bPPSGen: Learning to Generate Presentation Slides for Academic Papers\b", (201308, 0)),
    (r"\bAPE: Argument Pair Extraction from Peer Review and Rebuttal", (202011, 0)),
    (r"\bTowards Topic-Aware Slide Generation for Academic Papers\b", (202105, 0)),
    (r"\bCombinatorial Scientific Discovery: Finding New Concept Combinations\b", (202204, 0)),
    (r"\bPosterBot: A System for Generating Posters of Scientific Papers\b", (202206, 0)),
    (r"\bASAP-Review: A Dataset for Academic Paper Review Generation\b", (202209, 0)),
    # DOI pages do not encode release years; keep closure-added records sortable.
    (r"10\.1002/cesm\.70067", (202612, 0)),
    (r"10\.1111/jmi\.70110", (202612, 0)),
    (r"10\.57035/journals/sdk\.2026\.e41\.2397", (202612, 0)),
    (r"10\.1080/09544828\.2024\.2427558", (202512, 0)),
    (r"10\.5194/gc-9-371-2026", (202612, 0)),
    (r"10\.3998/jep\.6036", (202512, 0)),
    (r"10\.1590/1982-7849rac2026260041\.en", (202612, 0)),
    (r"10\.1098/rsos\.252472", (202612, 0)),
    (r"10\.1186/s41073-026-00217-y", (202612, 0)),
    (r"10\.1080/08989621\.2026\.2721689", (202612, 0)),
    (r"10\.1371/journal\.pbio\.3003334", (202512, 0)),
    (r"10\.1098/rsos\.250754", (202512, 0)),
    (r"10\.1075/jsls\.00045\.liu", (202512, 0)),
    (r"10\.1098/rsos\.240857", (202512, 0)),
    (r"10\.1371/journal\.pone\.0348512", (202612, 0)),
    (r"10\.1098/rsos\.242076", (202512, 0)),
    (r"10\.1177/00307270261477118", (202612, 0)),
    (r"10\.1145/3736731\.3746161", (202512, 0)),
    (r"10\.64898/2026\.07\.15\.738584", (202607, 0)),
    (r"10\.64898/2026\.05\.16\.724131", (202605, 0)),
    (r"10\.1038/s41597-025-04756-9", (202512, 0)),
    (r"10\.3390/data11050120", (202612, 0)),
    (r"10\.1177/25152459261434881", (202612, 0)),
    (r"10\.1017/9781009003391", (202512, 0)),
    (r"10\.1136/bmjebm-2024-113532", (202512, 0)),
    (r"10\.1002/leap\.2025", (202512, 0)),
