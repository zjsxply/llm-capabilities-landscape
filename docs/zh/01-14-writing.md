...
- [ARIS paper-writing](https://skills.sh/wanshuiyin/auto-claude-code-research-in-sleep/paper-writing) 适合需要把论文规划、图表、LaTeX 编译、跨模型审阅、主张审计、引用审计和投稿 gate 串成一条链路的科研论文写作流程。
- [Orchestra ML paper-writing skills](https://github.com/Orchestra-Research/AI-Research-SKILLs/tree/main/20-ml-paper-writing) 覆盖 ML 论文写作、系统论文写作、学术绘图、会议报告和 venue template 流程，可补充 PaperWritingBench 式分阶段学术写作任务。
