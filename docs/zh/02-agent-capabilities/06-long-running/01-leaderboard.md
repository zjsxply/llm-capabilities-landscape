...
- [Vending-Bench / Vending-Bench 2 Leaderboards](https://andonlabs.com/evals/vending-bench-2)：Andon Labs 官方长程业务运营 ranking；原始 [Vending-Bench](https://andonlabs.com/evals/vending-bench) 作为已弃用的历史榜单保留，[Vending-Bench Arena](https://andonlabs.com/evals/vending-bench-arena) 则加入多 agent competition 变体。
...
- [DeepPlanning Leaderboard](https://qwenlm.github.io/Qwen-Agent/en/benchmarks/deepplanning/)：Qwen 官方 benchmark 页面维护 v1.0 与 v1.1 长程旅行和购物规划排名，包括平均准确率以及分领域约束分数。
...
- [HORIZON Leaderboard](https://xwang2775.github.io/horizon-leaderboard/)：跨领域 long-horizon agent evaluation 的官方榜单，把最终分数和基于轨迹的失败归因放在一起，对应规划、记忆、工具使用与恢复失败等维度。
...
- [π-Bench Results](https://simplified-reasoning.github.io/Pi-Bench/)：官方项目页报告主动式个人助理 agent 在长程工作流中的结果；它是结果页而非公开提交榜。
