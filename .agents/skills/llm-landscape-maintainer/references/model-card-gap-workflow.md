...
4. Build the repository inventory from `docs/en/*.md` first, then spot-check `docs/zh/*.md` for bilingual alignment. Normalize aliases before deciding a benchmark is missing.
...
- Do not update only README or only one language side when adding a new category. Add `docs/en`, `docs/zh`, `README.md`, and `README.zh.md` together.
